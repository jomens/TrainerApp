...
angular.module('TrainerApp').controller("ProgressChartCtrl", function ($scope) {
    ...
    chart1.data = {"cols": [
        ...
        {id: "laptop-id", label: "Endurance", type: "number"},
        {id: "desktop-id", label: "Speed", type: "number"},
        {id: "server-id", label: "Weight", type: "number"},
        {id: "cost-id", label: "Duration", type: "number"}
    ], "rows": [
        {c: [
            {v: "January"},
            {v: 19, f: "42 items"},
    ...
    chart1.options = {
        ...
        "vAxis": {
            "title": "Activity Index", "gridlines": {"count": 10}
        },
        "hAxis": {
            "title": "Date"
        }
